...
enum Screen {
  ...
  Text headingWidget(BuildContext context, String heading, {screen = Screen.swipingScreen}) {
    return Text(
...
Container dropDownButtonWithoutPadding(BuildContext context, GlobalKey dropDownKey, Screen screen) {
  ...
  @override
  State<ChatScreenHeadingWithFiltersOption> createState() => _ChatScreenHeadingWithFiltersOptionState();
}

class _ChatScreenHeadingWithFiltersOptionState extends State<ChatScreenHeadingWithFiltersOption> {
  @override
          ...
          children: [
            GestureDetector(
              ...
              child: CircleAvatarWidget(
                  marginWidth16(context), widget.displayPic),
            ),
            SizedBox(
                ...
                ? DropdownButtonHideUnderline(
                    child: DropdownButton(
                      ...
                      items: labelToInterest.entries
                          .map((e) => nicheSelectedOption(
                            context, e.value))
                          .toList(),
                      onChanged: (itemIdentifier) async {
                        InterestType interest =
                            labelToInterest[itemIdentifier]!;
                        updateUserInterest(widget.threadId,
